				...
				<div class="navbar navbar-inverse navbar-static-top" role="navigation">
					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-nav">
							...
							<?php $myWebsite='http://localhost:80'; if($myWebsite!='') { echo '<li><a class="navbar-brand" href="javascript:extractHostname()">' . tr('My Website') . '</a></li>'; } ?>
